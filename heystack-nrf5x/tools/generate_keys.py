...
def generate_unique_id():  
    ...
    unique_id = ''  
    for _ in range(6):  
        remainder = timestamp % 36  
        unique_id = chars[remainder] + unique_id  
...
parser.add_argument('-o', '--output', help='output folder', default='keys/')
parser.add_argument(
...
addHashedAdvKeysS = ''
if (len(additionalHashedAdvKeys) > 0):

...
while true; do
    ...
    # --- 命令和目录配置 ---
    OPNOCD_CHECK_DIR="$PROJECT_ROOT/heystack-nrf5x/nrf51822/armgcc"
    OPNOCD_CMD='openocd -f openocd.cfg -c "init; exit"'
    DIR_TO_DELETE="$PROJECT_ROOT/heystack-nrf5x/nrf51822/armgcc/_build"
    FLASH_CMD="make -C heystack-nrf5x/nrf51822/armgcc stflash-nrf51822_xxac-patched HAS_DCDC=1 HAS_BATTERY=1 KEY_ROTATION_INTERVAL=900 MAX_KEYS=200 ADVERTISING_INTERVAL=${ADVERTISING_INTERVAL} ADV_KEYS_FILE=../../../config/${KEY_FILE_NAME}"
